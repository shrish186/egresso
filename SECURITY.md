...
agentwall is early-stage software. If you find a way to bypass enforcement, please open
...
For anything you believe is genuinely sensitive (e.g. a vulnerability in agentwall's own
code that could harm a user running it), email the maintainer instead of filing publicly.

## Scope & guarantees

agentwall reduces the blast radius of a compromised or prompt-injected agent. It is a
